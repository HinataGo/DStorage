...
#ROOT_DIR=$GOPATH/dstorage
ROOT_DIR=/code_tmp/data/log/
services="
proxy
upload
download
...
# 容器启动示例
# 启动account service
# docker run -it -e PARAMS="--registry=consul --registry_address=192.168.200.212:8500" hub.fileserver.com/filestore/user